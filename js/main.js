...
function loadInfo() {
    ...
    heatCarrierInfo.innerHTML = `
        <ul>
            <li>Температура подачи: 95-105°C</li>
            <li>Температура обратки: 70-75°C</li>
            <li>Давление: 6-8 атм</li>
            <li>Тип теплоносителя: вода</li>
        </ul>
    `;
    ...
    technicalInfo.innerHTML = `
        <ul>
            <li>Тип системы: закрытая</li>
            <li>Схема подключения: независимая</li>
            <li>Расчетная тепловая нагрузка: 0.8-1.2 Гкал/час</li>
            <li>Нормативные потери: 5-7%</li>
        </ul>
    `;
}
